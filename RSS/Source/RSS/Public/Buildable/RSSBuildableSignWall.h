...
#include "RSSBuildableSignWall.generated.h"

class URssWidgetRenderComponent;

UCLASS()
class ARSSBuildableSignWall : public AFGBuildableWall, public IRssSignInterface, public IFGSignificanceInterface
{
	GENERATED_BODY()

public:
	ARSSBuildableSignWall();

	//~ Begin AFGBuildableWall Interface
	...
	//~ End AFGBuildableWall Interface
