...
#include "RSSBuildableSignFoundation.generated.h"

UCLASS()
class ARSSBuildableSignFoundation : public AFGBuildableFoundation,
									public IRssSignInterface,
									public IFGSignificanceInterface
{
	GENERATED_BODY()

public:
	ARSSBuildableSignFoundation();

	//~ Begin AFGBuildableFoundation Interface
	...
	//~ End AFGBuildableFoundation Interface
	...
	float mDistanceMultiplier = 1.5f;
