...
#include "RSSBuildableSignWalkway.generated.h"

class URssWidgetRenderComponent;

UCLASS()
class ARSSBuildableSignWalkway : public AFGBuildableWalkway, public IRssSignInterface, public IFGSignificanceInterface
{
	GENERATED_BODY()

public:
	ARSSBuildableSignWalkway();

	//~ Begin AFGBuildableWalkway Interface
	...
	//~ End AFGBuildableWalkway Interface
