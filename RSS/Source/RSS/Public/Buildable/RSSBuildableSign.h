...
#include "RSSBuildableSign.generated.h"

UCLASS(Blueprintable, BlueprintType)
class RSS_API URSSSignClipboardSettings : public UKPCLBaseClipboardSettings
{
	GENERATED_BODY()
...
UCLASS()
class RSS_API ARSSBuildableSign : public AFGBuildable, public IRssSignInterface, public IFGSignificanceInterface
{
	GENERATED_BODY()
