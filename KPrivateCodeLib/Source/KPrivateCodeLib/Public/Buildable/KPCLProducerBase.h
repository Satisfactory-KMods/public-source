...
struct FKPCLMeshOverwriteInformation
{
	...
	UPROPERTY(SaveGame, BlueprintReadOnly, EditAnywhere)
	TObjectPtr<UStaticMesh> mOverwriteMesh = nullptr;

	UPROPERTY(SaveGame, BlueprintReadOnly, EditAnywhere)
	TMap<int32, TObjectPtr<UMaterialInterface>> mMaterialOverwriteMap;
...
UCLASS(Abstract)
class KPRIVATECODELIB_API AKPCLProducerBase : public AFGBuildableFactory,
