...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FKPCLOnCoreMinimumStoragePercentageChanged, float,
											MinimumStoragePercentage);
...
public:
	...
	float GetMinimumStoragePercentage() const { return FMath::Clamp(mMinimumStoragePercentage, 0.f, 100.f); }
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "KMods|Faxit")
	int32 TryToGrabItemAmountAboveReserve(TSubclassOf<UFGItemDescriptor> Item, int32 Amount);
	...
	FKPCLOnCoreMinimumStoragePercentageChanged mOnMinimumStoragePercentageChanged;
...
protected:
	...
	UFUNCTION()
	void OnRep_MinimumStoragePercentage();

	UPROPERTY(SaveGame, EditDefaultsOnly, BlueprintReadOnly,
			  meta = (FGReplicatedUsing = OnRep_MinimumStoragePercentage, ClampMin = "0.0", ClampMax = "100.0"),
			  Category = "KMods|DeliveryTask")
	float mMinimumStoragePercentage = 0.f;
