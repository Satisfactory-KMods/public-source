...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_KMods_DeliveryGateUnlock, "KMods.Delivery.GateUnlock",
							   "Allows a one-time delivery task without any payload; it only gates its children.");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_KMods_PlannerRawRecipe, "KMods.PlannerRawRecipe",
							   "Marks a Recipe to be a raw recipe");
