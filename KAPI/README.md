...
| `mIcon` | `UTexture2D` | Icon used in UI |
...
- **Height-based production**: yield scales with altitude (`bUseHightBasesdProduction`), with min, max, and base values per scan cycle
